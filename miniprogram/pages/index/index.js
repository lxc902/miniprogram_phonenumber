...
Page({
  ...
  phoneClk (e) { 
    ...
    console.log('e.detail.cloudID=',e.detail.cloudID)  
    
    wx.showLoading({
      title: 'hi2',
    });
    var request = {
      name: 'getPhoneNumberFromCode',
      config: {
        env: this.data.selectedEnv.envId // This is really important!
      },
      data: { // this is 'event' in cloud. I.e. use "event.code" to get "data.code" here.
        code: e.detail.code
      }
    };
